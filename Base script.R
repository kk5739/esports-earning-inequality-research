...
library(dplyr)
library(jsonlite)
APILINK <- 'http://api.esportsearnings.com/v0/LookupGameById?apikey=a9abe33e39059a81b2fa1a9648bfbd38572205890f9bdfa50ceca7208a9da065&gameid=151'
gamefeaturesGET <- APILINK %>%
  httr::GET(config = httr::config(ssl_verifypeer = FALSE)) %>%
  content(as = "text") %>%
  fromJSON()
gamefeaturesGET
APILINK <- 'http://api.esportsearnings.com/v0/LookupHighestEarningPlayersByGame?apikey=a9abe33e39059a81b2fa1a9648bfbd38572205890f9bdfa50ceca7208a9da065&gameid=151&offset=0'
